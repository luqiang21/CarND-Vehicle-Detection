...
# Note here, the folder name: KITTI_extracted also has 'extra' in it, so car image will be included in noncars.
images = glob.glob('C:\\Users\\Qiang\\Downloads\\SDC\\non-vehicles\\Extras\\*.png')
images += glob.glob('C:\\Users\\Qiang\\Downloads\\SDC\\vehicles\\KITTI_Extracted\\*.png')
cars = []
notcars = []
for image in images:
